...
function Get-SessionInfo {
    ...
    function Get-Username {
        ...
        $script:sessionReport += $usernameMessage
    ...
    function Get-LastBootTime {
        ...
        $script:sessionReport += $bootTimeMessage
...
"@
    ...
    function Get-OSInfo {
        ...
        $script:sessionReport += $osInfoMessage
    ...
    function Check-OSUpdates {
        ...
        if ($updates) {
            ...
            $script:sessionReport += $updateMessages
        } else {
            $updateMessage = "No OS updates found."
            $script:sessionReport += $updateMessage
