...
function Get-HardwareInfo {
    ...
    function Get-SystemMakeModel {
        ...
        $script:hardwareReport += $makeModelMessage
    ...
    function Get-ProcessorInfo {
        ...
        $script:hardwareReport += $processorMessage
    ...
    function Get-BiosVersion {
        ...
        $script:hardwareReport += $biosMessage
    ...
    function Get-MemoryInfo {
        ...
        foreach ($mem in $memory) {
            ...
            $script:hardwareReport += $memoryMessage
        }
    ...
    function Get-DiskInfo {
        ...
        foreach ($disk in $disks) {
            ...
            $script:hardwareReport += $diskMessage
        }
    ...
    function Get-GraphicsInfo {
        ...
        foreach ($card in $graphics) {
            ...
            $script:hardwareReport += $graphicsMessage
        }
    ...
    function Get-NetworkAdapterInfo {
        ...
        foreach ($adapter in $adapters) {
            ...
            $script:hardwareReport += $adapterMessage
        }
    ...
    function Get-BatteryInfo {
        ...
        if ($battery) {
            ...
            $script:hardwareReport += $batteryMessage
        } else {
